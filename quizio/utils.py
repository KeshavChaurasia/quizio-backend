...
def parse_query_string(query_string):
    ...
    """
    decoded_string = query_string.decode("utf-8")  # Decode the byte string to a normal string
    ...
    return {key: value[0] if len(value) == 1 else value for key, value in parsed_params.items()}
